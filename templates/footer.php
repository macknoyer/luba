    ...
    <footer class="footer-area">
        ...
        <div class="footer-logo-area pt-30 pb-80">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="footer-logo mt-50">
                           <a href="index.html">
                            ...
                            <p class="text">Luba’s New York home health care, one of the best home health care agencies in NYC, serves all clients of all ages, from all walks of life. Our goal is to improve your everyday life and fill it with ease and comfort.</p>
                        </div> <!-- footer-logo -->
                    </div>
                    <div class="col-lg-6">
                        <div class="footer-subscribe mt-45">
                            <div class="footer-title">
    ...
    <a href="#" class="back-to-top"><i class="la la-angle-right"></i><span>Back To Top</span></a>
